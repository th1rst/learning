...
export default class BesonderesUndBeilagen extends Component {
        ...
        <div className="recipe-list-container">
          <div className="recipe-list-heading-row">
            <p className="recipe-list-heading">
              Alle Rezepte der Kategorie "Besonderes und Beilagen":
            </p>
          </div>
          <div className="divider-small"></div>
          {recipes.map((recipe) => {
            if (recipe.dish_category === "Besonderes und Beilagen") {
              return (
